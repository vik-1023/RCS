...
import user.SendAttachmentMail;
...
public class telegramLoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        dbcon db = new dbcon();
        db.getCon("User_Billing_Api_Login");
        ...
        String Login_data = "select username ,password,chat_id,email from users where username ='" + username + "' and password=MD5('" + password + "')  and status='true' ";
    ...
    private String sendOtpMail(String Session_otp, String email) {
        ...
        String msg = "Your User Billing Api Login Otp is:" + Session_otp;
