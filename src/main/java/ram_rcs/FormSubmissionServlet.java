...
//C:/Users/Ram Ishwer Kumar/Documents/NetBeansProjects/RCS/Ram/   D:/RCS/RCS/Ram
        ...
        formData.setLabelPhoneNumber(request.getParameterValues("labelPhoneNumber"));
        ...
        formData.setLabelemailAddress(request.getParameterValues("labelemailAddress"));
        
        formData.setWebsiteAddresses(request.getParameterValues("websiteUrl"));
        formData.setLabelwebsiteUrl(request.getParameterValues("labelwebsiteUrl"));
        ...
        String concatenatedWebsiteUrls = String.join(",", formData.getWebsiteAddresses());
         ...
         String labelPhoneNumber = String.join(",", formData.getLabelPhoneNumber());
         System.out.println("labelPhoneNumber:"+ labelPhoneNumber);
                 
         String labelemailAddress = String.join(",", formData.getLabelemailAddress());
         String labelwebsiteUrl= String.join(",", formData.getLabelwebsiteUrl());
        ...
        try {
            ...
            String insertQuery = "INSERT INTO rbm_table (phone_number, development_platform, chatbot_webhook, email_address, "
                    ...
                    + "short_description, website_url,color,url_data,banner_url_data,image_data,banner_image_data,bot_name,form_checkbox,username,labelPhoneNumber,labelemailAddress,labelwebsiteUrl) VALUES ('" + concatenatedPhoneNumbers + "','" + DevelopmentPlatform + "','" + ChatbotWebhook + "','" + concatenatedemailAddresses + "','" + TermsOfUseUrl + "','" + PrivacyPolicyUrl + "','" + LanguagesSupported + "','" + concatenatedBotMessageTypes + "','" + BrandName + "','" + ShortDescription + "','" + concatenatedWebsiteUrls + "','" + Favcolors + "','" + imageurl + "','" + baneerurl + "','" + filepath_dh + "','" + filepath_dh1 + "','" + botname + "','" + agree + "','" + username + "','"+labelPhoneNumber+"','"+labelemailAddress+"','"+labelwebsiteUrl+"')";
