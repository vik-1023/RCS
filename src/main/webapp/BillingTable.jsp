...
//        } else {
        ...
        String sql = "SELECT SUBSTRING(DateRange, 1, 10) as DateRange,TransactionType,BasicMessageCount,A2PSingleMessageCount,A2PConversationCount,P2AConversationCount,Brands,Bots FROM tester_invite "
                + "WHERE DateRange BETWEEN '" + fdate
                + " 00:00:00' AND '" + tdate + " 23:59:59' AND Brands LIKE '" + BrandN + "' AND Bots LIKE '" + BotN + "' and username='" + username + "' GROUP BY " + List + " "
                + ";";
